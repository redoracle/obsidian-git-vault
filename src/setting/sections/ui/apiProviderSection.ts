                ...
                new Setting(sectionContainerEl)
                    ...
                    .addText((t) => {
                        ...
                        t.onChange(async (v) => {
                            ...
                            // Only normalise the displayed value when the
                            // normalised form differs AND the user has finished
                            // a "word" (trailing slash stripped etc.) — never
                            // call setValue mid-keystroke or focus is lost.
                            if (
                                v !== trackedDirectory &&
                                !v.endsWith("/") &&
                                !v.endsWith("\\")
                            ...
                            // Do NOT call refreshDisplayWithDelay() here — it
                            // re-renders the entire settings tab and destroys
                            // the focused input, causing focus loss on every
                            // keystroke.
                        });
                    });
                ...
                new Setting(containerEl)
                    ...
                    .addTextArea((ta) => {
                        ...
                        ta.onChange(async (v) => {
                            ...
                            await reloadSyncManager();
                            // Do NOT call refreshDisplayWithDelay() — same
                            // reason as Tracked directory above.
                        });
                    });
            },
        },
