...
export class ApiRemoteTargetWorkflow {
    ...
    private buildDecisionDescription(decision: RemoteTargetDecision): string {
        switch (decision.kind) {
            case "new-target":
                return "Choose how Git Vault should use the selected remote. Upload this vault to push your local files to the remote. Import pulls the remote into the current vault first.";
                ...
                const options: ApiRemoteActionOption[] = [
                    {
                        ...
                        description:
                            "Push all local vault files (including .obsidian and notes) to the selected remote, excluding the configured Excluded Paths.",
                        cta: true,
                    },
                    {
                        action: "import-current-vault",
                        label: "Import from remote into current vault",
                        description:
