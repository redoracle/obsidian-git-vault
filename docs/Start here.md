...
> If you are using the GitHub/GitLab/Gitea API backends with **Encrypt synced file contents** enabled, read [Gitless-Mode.md](Gitless-Mode.md). Clone/import workflows require the exporting device to already know the passphrase for that remote.
